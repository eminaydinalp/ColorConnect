...
namespace Rentire.Utils
{
    ...
    public static class UserPrefs {
        ...
        public static int GetCreatingLevelNo()
        {
            return LocalPrefs.GetInt(PrefType.CreatingLevel.ToString(), 1);
        }
        
        public static void IncreaseCreatingLevelNo()
        {
            var level = GetCreatingLevelNo();
            level++;
            SetCreatingLevelNo(level);
        }

        public static void SetCreatingLevelNo(int level)
        {
            LocalPrefs.SetInt(PrefType.CreatingLevel.ToString(), level);
            Save();
        }
        ...
        public static void SetMoveLeft(int moveCount)
        {
            LocalPrefs.SetInt(PrefType.MoveLeft.ToString(), GetMoveLeft() + moveCount);
            Save();
        }
        public static int GetMoveLeft()
        {
            return LocalPrefs.GetInt(PrefType.MoveLeft.ToString(), 0);
        }
